...
export default function FilterMenu() {
    ...
    // --- OPTIMIZATION: Single Object State ---
    const [menuState, setMenuState] = useState({
        isFilterOpen: false,
        isDateModalOpen: false,
        activeSubMenu: null, // "category" | "priority" | null
    });

    // Helper function to easily update one piece of the object
    const handleMenuChange = (key, value) => {
        setMenuState((prev) => ({ ...prev, [key]: value }));
    };

    // Passed the specific object properties to the hook
    ...
    const selectedCategory = filter.category === "all" ? "All" : filter.category;
    const selectedPriority = filter.priority === "all" ? "All" : filter.priority;
    ...
    return (
        <div className="relative" ref={filterRef}>
            ...
            {menuState.isFilterOpen && (
                <div className="absolute right-0 mt-2 mr-8 w-64 bg-[#FFFFFF] dark:bg-[#1D1D1F] border border-[#E8E8ED] dark:border-[#2D2D2F] rounded-2xl shadow-2xl z-20 py-1 scale-in-center overflow-hidden">
                    <div className="grid grid-cols-2 divide-x-2 divide-[#E8E8ED] dark:divide-gray-700">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 mt-2">
                                <button
                                    onClick={() => dispatch(tasksAction.setSort("createdAt"))}
                                ...
                                <button
                                    onClick={() => dispatch(tasksAction.setSort("dueDate"))}
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 mt-2">
                                ...
                                <div
                                    className="relative"
                                    onMouseEnter={() => handleMenuChange("activeSubMenu", "category")}
                                    onMouseLeave={() => handleMenuChange("activeSubMenu", null)}
                                >
                                    <button
                                ...
                                <div
                                    className="relative"
                                    onMouseEnter={() => handleMenuChange("activeSubMenu", "priority")}
                                    onMouseLeave={() => handleMenuChange("activeSubMenu", null)}
                                >
                                    <button
                                ...
                                {/* DATE RANGE */}
                                <button
                                    onClick={() => handleMenuChange("isDateModalOpen", true)}
                                ...
                                <Modal
                                    ...
                                    onClose={() => handleMenuChange("isDateModalOpen", false)}
                                >
                                    <DateRangeForm
                                        onClose={() => handleMenuChange("isDateModalOpen", false)}
                                    />
